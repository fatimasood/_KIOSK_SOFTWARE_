...
import '../../services/outdoor/printing_outdoor.dart';

class LeaseAgreementScreenOutdoor extends StatefulWidget {
  final Map<String, dynamic> formData; // Receive form data
  const LeaseAgreementScreenOutdoor({super.key, required this.formData});

  @override
  State<LeaseAgreementScreenOutdoor> createState() =>
      _LeaseAgreementScreenOutdoorState();
}

class _LeaseAgreementScreenOutdoorState
    extends State<LeaseAgreementScreenOutdoor> {
                    ...
                    WidgetSpan(
                      ...
                      child: SizedBox(
                        ...
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                            hintText: "vehicle/RV/Boat/Trailer, etc.",
                            hintStyle: AppStyles.bodytext1,
                            isDense: true,
                            contentPadding: EdgeInsets.symmetric(
                                horizontal: 5, vertical: 2),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                FinishScreenOutdoor(formData: formData),
                          ),
                        );
                      },
                      child: const Text(
