          ...
          pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Row(
                  children: [
                    pw.Text("Year: ", style: headingStyle1),
                    pw.SizedBox(width: 5.0),
                    pw.Text("${formData['year']} ", style: normalStyle),
                  ],
                ),
                pw.SizedBox(height: 25.0),
                pw.Row(
                  children: [
                    pw.Text("Make: ", style: headingStyle1),
                    pw.SizedBox(width: 5.0),
                    pw.Text("${formData['make']} ", style: normalStyle),
                  ],
                ),
                pw.SizedBox(height: 25.0),
                pw.Row(
                  children: [
                    pw.Text("Model: ", style: headingStyle1),
                    pw.SizedBox(width: 5.0),
                    pw.Text("${formData['model']} ", style: normalStyle),
                  ],
                ),
                pw.SizedBox(height: 25.0),
                pw.Row(
